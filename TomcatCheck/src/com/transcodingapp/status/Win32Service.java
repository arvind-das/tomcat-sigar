...
public class Win32Service extends SigarCommandBase {
    ...
    String triggerService(String[] arr)
    {
    	String currentStatus = null;
    	try
    	{
    		Service service=new Service(arr[0]);
    		Win32Service ob=new Win32Service();
    		if(service.getStatus()==Service.SERVICE_RUNNING)
    		{
    			ob.output(arr);
    			currentStatus = "stopped";
    			System.out.println("Service is stopped");
    		}
    		else if(service.getStatus()==Service.SERVICE_STOPPED)
    		{
